/*
 * Replacement openssl_config.h for wolfSSL compatibility
 * Based on Erlang/OTP original, modified for wolfSSL which does not
 * provide legacy cipher headers (blowfish, rc2, idea, mdc2, seed, cast)
 */
...
/* wolfSSL does not provide legacy cipher headers - guard them all */
#ifndef OPENSSL_NO_BF
    #define OPENSSL_NO_BF
#endif
/* blowfish.h intentionally omitted - not provided by wolfSSL */
...
/* OpenSSL 3.0+ provider API - not available in wolfSSL */
...
/* wolfSSL does not support Blowfish - OPENSSL_NO_BF already defined above */
/* #define HAVE_BF intentionally omitted */
...
/* OpenSSL 3.5+ post-quantum algorithms */
